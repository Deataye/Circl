...
const HomeHero = () => {
  ...
  return (
    <section
      className={`w-full px-6 lg:max-w-[1440px] lg:mx-auto md:px-16 lg:px-24 py-16 flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-[#FFF1F3] via-[#FAF0FD] to-[#F9F5FF] ${
        language === "AR" ? "rtl" : "ltr"
      }`}
    >
      {/* Left Section */}
