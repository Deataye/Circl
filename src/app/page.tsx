...
export default function Home() {
  ...
  <div className="absolute w-[873px] h-[939px] rounded-full top-[350px] -z-10  -left-[200px] blur-3xl bg-[#D6B28833] " ></div> 
  <div className="absolute w-[668px] h-[668px] rounded-full  -z-10 bottom-10 opacity-50 -right-[200px] blur-3xl bg-[#E6C3F2B2] " ></div>
      <Header />
      <HomeHero />
